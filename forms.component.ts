...
export class FormsComponent {
  ...
  // }
  constructor(public formBuilder: FormBuilder , public dialog: MatDialog, private dateAdapter: DateAdapter<Date> ) {
  ...
  onSubmit()
  {
    ...
    // this.parentPosts.push(this.userForm.value.name);
    // this.parentPosts.push(this.userForm.value.sname);
    // this.parentPosts.push(this.userForm.value.age);
    // // this.parentPosts.push(this.userForm.value.dob);
    // this.parentPosts.push(this.userForm.value.start);
    // this.parentPosts.push(this.userForm.value.end);
    // this.parentPosts.push(this.userForm.value.gen);
    // this.parentPosts.push(this.userForm.value.num);
    // this.parentPosts.push(this.userForm.value.email);
    // this.parentPosts.push(this.userForm.value.dept);
    // this.parentPosts.push(this.userForm.value.pwd);
    // this.parentPosts.push(this.userForm.value.cpwd);
